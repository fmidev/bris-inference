...
class Grib(Output):
    ...
    def param_to_id(self, param):
        ...
        return {
            ...
            "low_type_cloud_area_fraction": (0, 0, 6, 193, None),
            "medium_type_cloud_area_fraction": (0, 0, 6, 194, None),
            ...
            "integral_of_surface_downwelling_longwave_flux_in_air_wrt_time": (0, 0, 5, 4, None),
